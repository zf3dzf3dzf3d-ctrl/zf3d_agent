...
var DB = {
    ...
    setLoopMode: function(mode) {
        ...
        fetch(url, {
            ...
            body: JSON.stringify({ default_mode: parseInt(mode, 10) })
    ...
    checkOnline: function() {
        ...
        return fetch(url, { method: 'GET', timeout: 3000 })
    ...
    proxyStream: function(targetUrl, headers, payload, signal, onChunk, onDone) {
