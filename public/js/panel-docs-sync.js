 ...
 *   - ❓ 帮助面板  ← docs/使用帮助-5.1.5.md（中文）/ docs/使用帮助-EN.md（英文）
 *   - 📖 简介面板  ← docs/软件介绍-5.1.5.md
...
(function () {
    ...
    var MD_URLS = {
        help: { zh: 'docs/使用帮助-5.2.0.md', en: 'docs/使用帮助-EN.md' },
        intro: { zh: 'docs/软件介绍-5.2.0.md', en: 'docs/软件介绍-EN.md' }
    };
