...
var defaults={enabled:true,maxRounds:200,compressAfterMessages:99999,keepRecentMessages:20,observationDelayMs:300,loopBreakLimit:50,retryMaxPerRound:3,retryIntervalMs:3000,retryRounds429:2,retryBackoff429Ms:[5000,15000,40000,90000,180000],retryRounds:3,retryRoundIntervalMs:300000,contextTokenBudget:0,toolResultMaxChars:10000,toolResultKeepRecent:30,toolResultMaxKeep:50,avoidRedundantReply:true,steps:STEP_DEFAULTS};
...
function migrateSaved(raw){
  ...
  if(raw.retryRounds!=null&&raw.retryRounds===1){raw.retryRounds=3;changed=true;}
