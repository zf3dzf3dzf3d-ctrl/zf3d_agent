...
(function () {
  ...
  var CSS = [
    ...
    '#kg-detail{position:absolute;right:14px;top:14px;width:280px;max-height:70%;overflow:auto;background:rgba(10,16,36,.85);border:1px solid rgba(120,160,255,.25);border-radius:12px;padding:14px;display:none;font-size:12px;line-height:1.7;}',
