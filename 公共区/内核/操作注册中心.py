...
from 操作基类 import (
    ...
    Git状态, Git提交, Git回滚,
    Glob搜索, 符号搜索,
    Git差异, Git日志, Git分支, Git推送, Git拉取, Git暂存, Git标签,
    自动测试, 构建验证, 文件符号, 查找引用, 代码分析, 代码差异,
    网页分析, 图片分析, 网站发布,
...
class 操作注册中心类:
    ...
    def __init__(self):
        ...
        self._英文名映射 = {
            ...
            "Git推送": "git_push", "Git拉取": "git_pull", "Git暂存": "git_stash", "Git标签": "git_tag",
            "自动测试": "auto_test", "构建验证": "build_check",
            "文件符号": "document_symbol", "符号搜索": "workspace_symbol", "查找引用": "find_references",
            "代码分析": "code_analysis", "代码差异": "code_diff",
            "网页分析": "web_analyze", "图片分析": "image_analyze", "网站发布": "zf3d_publish",
            "Job创建": "job_create", "Job更新": "job_update",
            "Job列表": "job_list", "Job详情": "job_get",
            "后台执行": "bg_run", "获取后台结果": "bg_result",
            "查看后台进度": "bg_progress", "停止后台任务": "bg_stop",
        ...
        self._操作分组 = {
            ...
            "代码": {
                "操作": ["搜索代码", "Glob搜索", "符号搜索", "验证代码", "文件符号", "查找引用", "代码分析", "代码差异"],
            ...
            "网络": {
                "操作": ["网页抓取", "网络搜索", "网页分析", "图片分析", "网站发布"],
                "关键词": ["搜索", "网页", "抓取", "网络", "上网", "http", "url", "网址",
                           "分析图片", "分析网页", "fetch", "联网",
                           "发帖", "发布", "签到", "朱峰", "社区", "AIGC", "上传图片"],
                "优先级": 0,
            },
            ...
            "高级核心": {
                "操作": ["子代理", "并行执行", "后台执行", "获取后台结果", "查看后台进度", "停止后台任务", "查Bug"],
                "关键词": ["子代理", "并行", "后台", "agent", "进度", "停止"],
                "优先级": 0,
            },
            "高级编排": {
            ...
            "Git": {
                "操作": ["Git状态", "Git提交", "Git回滚", "Git差异", "Git日志", "Git分支", "Git推送", "Git拉取", "Git暂存", "Git标签"],
    ...
    def 注册内置操作(self):
        ...
        内置操作列表 = [
            ...
            Glob搜索(),
            Git差异(), Git日志(), Git分支(), Git推送(), Git拉取(), Git暂存(), Git标签(),
            自动测试(), 构建验证(), 文件符号(), 符号搜索(), 查找引用(),
            代码分析(), 代码差异(),
            网页分析(), 图片分析(), 网站发布(),
            Job创建(), Job更新(), Job列表(), Job详情(),
            后台执行(), 获取后台结果(), 查看后台进度(), 停止后台任务(),
            子代理(), 并行执行(),
            串行流水线(), Barrier(), LoopUntilDry(),
            查Bug(), 编程循环(),
            查询运行错误(), 解决运行错误(), 清除已解决错误(),
        ...
        别名映射 = {
            ...
            "刷新索引": "符号搜索", "生成骨架": "符号搜索", "更新项目索引": "符号搜索", "重建索引": "符号搜索",
            "列出符号": "文件符号", "文件结构": "文件符号", "查看符号": "文件符号",
            "找引用": "查找引用", "引用搜索": "查找引用", "谁调用了": "查找引用",
            "git push": "Git推送", "推送": "Git推送", "push": "Git推送",
            "git pull": "Git拉取", "拉取": "Git拉取", "pull": "Git拉取",
            "git stash": "Git暂存", "暂存": "Git暂存", "stash": "Git暂存",
            "git tag": "Git标签", "标签": "Git标签", "打标签": "Git标签",
            "分析代码": "代码分析", "代码质量": "代码分析", "检查代码": "代码分析",
            "diff文件": "代码差异", "比较文件": "代码差异", "文件差异": "代码差异", "预览变更": "代码差异",
            "分析网页": "网页分析", "fetch": "网页分析",
            "分析图片": "图片分析", "看图": "图片分析",
            "发帖": "网站发布", "发布": "网站发布", "发文章": "网站发布", "发作品": "网站发布",
            "上传图片": "网站发布", "网站签到": "网站发布", "AIGC发布": "网站发布", "社区发布": "网站发布",
